...
namespace Gibraltar.Data
{
    ...
    /// </summary>
    public abstract class FileMaintenanceBase : IDisposable
    {
        /// <summary>
        ...
        private bool RemoveSessionFragment(FileInfo victimFile)
        {
            ...
            try
            {
                ...
                using (FileLock fileLock = Win32Helper.GetFileLock(victimFile.FullName, FileMode.Open, FileAccess.Read, FileShare.Delete))
                {
                    if (fileLock != null)
                    {
                        victimFile.Delete();
