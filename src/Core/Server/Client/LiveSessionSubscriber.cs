...
namespace Gibraltar.Server.Client
{
    ...
    /// </summary>
    public class LiveSessionSubscriber : NetworkClient, ISessionPacketCache
    {
        ...
        public LiveSessionSubscriber(NetworkConnectionOptions options, Guid repositoryId, Guid sessionId, Guid channelId, long lastSequence)
            : this(options, repositoryId, sessionId, channelId, lastSequence, FileHeader.DefaultMajorVersion, FileHeader.DefaultMajorVersion)
        {
        }
        ...
        public LiveSessionSubscriber(NetworkConnectionOptions options, Guid repositoryId, Guid sessionId, Guid channelId, long lastSequence, int majorVersion, int minorVersion)
        ...
        /// </summary>
        public Guid ChannelId { get { return m_ChannelId; } }
        ...
        /// </summary>
        public long LastSequence { get { return m_LastSequence; } }
        ...
        /// </summary>
        public TimeSpan ClockDrift { get { return m_ClockDrift; } set { m_ClockDrift = value; } }
                ...
                if (nextPacket != null)
                {
                    try
                    {
                        ...
                        if ((logMessagePacket = nextPacket as LogMessagePacket) != null) //this covers trace packet too
                        {
                            ...
                            if (m_Threads.TryGetValue(logMessagePacket.ThreadIndex, out threadInfo))
                            {
        ...
        protected override void OnPacketFactoryRegister(PacketReader packetReader)
        {
            ...
            LogMessagePacketFactory logMessagePacketFactory = new LogMessagePacketFactory(this);
