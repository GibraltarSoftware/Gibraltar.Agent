...
namespace Gibraltar.Server.Data
{
    /// <summary>
    ...
    internal static class DataConverter
    {
        ...
        /// <returns></returns>
        public static BootMode FromBootModeXml(BootModeXml bootModeXml)
        {
            return (BootMode)Enum.Parse(typeof(BootMode), bootModeXml.ToString(), true);
        }
