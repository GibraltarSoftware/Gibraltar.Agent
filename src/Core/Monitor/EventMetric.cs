...
namespace Gibraltar.Monitor
{
    ...
    public class EventMetric : Metric, IEventMetric
    {
        ...
        {
            var effectiveStartDateTime = (startDateTime == null ? this.StartDateTime : (DateTimeOffset)startDateTime);
            var effectiveEndDateTime = (endDateTime == null ? this.EndDateTime : (DateTimeOffset)endDateTime);
