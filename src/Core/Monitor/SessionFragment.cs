...
namespace Gibraltar.Monitor
{
    ...
    public class SessionFragment
    {
        ...
        /// </summary>
        public long MessageCount { get { return m_SessionFile?.SessionHeader.MessageCount ?? 0; } }

        /// <summary>
        /// The number of critical messages recorded in the entire session up through this fragment.
        /// </summary>
        public long CriticalCount { get { return m_SessionFile?.SessionHeader.CriticalCount ?? 0; } }

        /// <summary>
        /// The number of error messages recorded in the entire session up through this fragment.
        /// </summary>
        public long ErrorCount { get { return m_SessionFile?.SessionHeader.ErrorCount ?? 0; } }

        /// <summary>
        /// The number of warning messages recorded in the entire session up through this fragment.
        /// </summary>
        public long WarningCount { get { return m_SessionFile?.SessionHeader.WarningCount ?? 0; } }

        /// <summary>
        /// The compressed stream size
        /// </summary>
        public long Size { get { return m_SessionFile?.FragmentStorageSummary.FragmentSize ?? 0; }}
