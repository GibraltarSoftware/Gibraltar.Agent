...
namespace Gibraltar.Monitor.Internal
{
    internal class AssemblyInfoPacket : GibraltarCachedPacket, IPacket, IEquatable<AssemblyInfoPacket>
    {
        ...
        public string ImageRuntimeVersion { get { return m_ImageRuntimeVersion; } set { m_ImageRuntimeVersion = value; } }

        public string Location { get { return m_Location; } set { m_Location = value; } }

        public string Name { get { return m_Name; } set { m_Name = value; } }

        public ProcessorArchitecture ProcessorArchitecture { get { return m_ProcessorArchitecture; } set { m_ProcessorArchitecture = value; } }

        public bool GlobalAssemblyCache { get { return m_GlobalAssemblyCache; } set { m_GlobalAssemblyCache = value; } }
        ...
        void IPacket.ReadFields(PacketDefinition definition, SerializedPacket packet)
        {
            switch (definition.Version)
            {
                case 1:
                    ...
                    int processorArchitectureRaw;
                    packet.GetField("ProcessorArchitecture", out processorArchitectureRaw);
