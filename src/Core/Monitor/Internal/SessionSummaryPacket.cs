...
namespace Gibraltar.Monitor.Internal
{
    ...
    internal class SessionSummaryPacket : GibraltarCachedPacket, IPacket, IEquatable<SessionSummaryPacket>
    {
            ...
            : base(sessionHeader.Id, true)
        {
            ...
            m_ApplicationType = (ApplicationType)Enum.Parse(typeof(ApplicationType), sessionHeader.ApplicationTypeName, true);
        ...
        /// </summary>
        public Guid ComputerId { get { return m_ComputerId; } set { m_ComputerId = value; } }

        public DateTimeOffset EndDateTime { get { return m_EndDateTime; } set { m_EndDateTime = value; } }
        ...
        public string Caption
        {
            ...
            set
            {
                m_Caption = SetSafeStringValue(value, 1024);
            }
        }

        public string TimeZoneCaption { get { return m_TimeZoneCaption; } set { m_TimeZoneCaption = SetSafeStringValue(value, 120); } }

        public string ProductName { get { return m_ProductName; } set { m_ProductName = SetSafeStringValue(value, 120); } }

        public string ApplicationName { get { return m_ApplicationName; } set { m_ApplicationName = SetSafeStringValue(value, 120); } }

        public string EnvironmentName { get { return m_EnvironmentName; } set { m_EnvironmentName = SetSafeStringValue(value, 120); } }

        public string PromotionLevelName { get { return m_PromotionLevelName; } set { m_PromotionLevelName = SetSafeStringValue(value, 120); } }

        public ApplicationType ApplicationType { get { return m_ApplicationType; } set { m_ApplicationType = value; } }

        public string ApplicationDescription { get { return m_ApplicationDescription; } set { m_ApplicationDescription = SetSafeStringValue(value, 1024); } }

        /// <summary>
        /// The version of the application that recorded the session
        /// </summary>
        public Version ApplicationVersion { get { return m_ApplicationVersion; } set { m_ApplicationVersion = value; } }

        public Version AgentVersion { get { return m_AgentVersion; } set { m_AgentVersion = value; } }

        public string HostName { get { return m_HostName; } set { m_HostName = SetSafeStringValue(value, 120); } }

        public string DnsDomainName { get { return m_DnsDomainName; } set { m_DnsDomainName = SetSafeStringValue(value, 512); } }
        ...
        public int OSPlatformCode { get { return m_OSPlatformCode; } set { m_OSPlatformCode = value; } }
        public Version OSVersion { get { return m_OSVersion; } set { m_OSVersion = value; } }
        public string OSServicePack { get { return m_OSServicePack; } set { m_OSServicePack = SetSafeStringValue(value, 50); } }
        public string OSCultureName { get { return m_OSCultureName; } set { m_OSCultureName = SetSafeStringValue(value, 50); } }
        public ProcessorArchitecture OSArchitecture { get { return m_OSArchitecture; } set { m_OSArchitecture = value; } }
        public BootMode OSBootMode { get { return m_OSBootMode; } set { m_OSBootMode = value; } }
        public int OSSuiteMask { get { return m_OSSuiteMaskCode; } set { m_OSSuiteMaskCode = value; } }
        public int OSProductType { get { return m_OSProductTypeCode; } set { m_OSProductTypeCode = value; } }
        public Version RuntimeVersion { get { return m_RuntimeVersion; } set { m_RuntimeVersion = value; } }
        public ProcessorArchitecture RuntimeArchitecture { get { return m_RuntimeArchitecture; } set { m_RuntimeArchitecture = value; } }
        public string CurrentCultureName { get { return m_CurrentCultureName; } set { m_CurrentCultureName = SetSafeStringValue(value, 50); } }
        public string CurrentUICultureName { get { return m_CurrentUICultureName; } set { m_CurrentUICultureName = SetSafeStringValue(value, 50); } }
        public int MemoryMB { get { return m_MemoryMB; } set { m_MemoryMB = value; } }
        public int Processors { get { return m_Processors; } set { m_Processors = value; } }
        public int ProcessorCores { get { return m_ProcessorCores; } set { m_ProcessorCores = value; } }
        public bool UserInteractive { get { return m_UserInteractive; } set { m_UserInteractive = value; } }
        public bool TerminalServer { get { return m_TerminalServer; } set { m_TerminalServer = value; } }
        ...
        public int ColorDepth { get { return m_ColorDepth; } set { m_ColorDepth = value; } }
        public string CommandLine { get { return m_CommandLine; } set { m_CommandLine = SetSafeStringValue(value, 2048); } }
        ...
        void IPacket.ReadFields(PacketDefinition definition, SerializedPacket packet)
        {
            ...
            m_OSBootMode = (BootMode)osBootModeRaw;
        ...
        public override int GetHashCode()
        {
            ...
            if (m_ComputerId != null) myHash ^= m_ComputerId.GetHashCode(); // Fold in hash code for string ProductName
            if (m_ProductName != null) myHash ^= m_ProductName.GetHashCode(); // Fold in hash code for string ProductName
            if (m_ApplicationName != null) myHash ^= m_ApplicationName.GetHashCode(); // Fold in hash code for string ApplicationName
            if (m_EnvironmentName != null) myHash ^= m_EnvironmentName.GetHashCode(); // Fold in hash code for string EnvironmentName
            if (m_PromotionLevelName != null) myHash ^= m_PromotionLevelName.GetHashCode(); // Fold in hash code for string PromotionName
            if (m_ApplicationVersion != null) myHash ^= m_ApplicationVersion.GetHashCode(); // Fold in hash code for string ApplicationVersion
            myHash ^= m_ApplicationType.GetHashCode(); // Fold in hash code for string ApplicationTypeName
            if (m_ApplicationDescription != null) myHash ^= m_ApplicationDescription.GetHashCode(); // Fold in hash code for string ApplicationDescription
            if (m_Caption != null) myHash ^= m_Caption.GetHashCode(); // Fold in hash code for string Caption
            if (m_TimeZoneCaption != null) myHash ^= m_TimeZoneCaption.GetHashCode(); // Fold in hash code for string TimeZoneCaption
            myHash ^= m_EndDateTime.GetHashCode(); // Fold in hash code for DateTimeOffset member EndDateTime
            if (m_AgentVersion != null) myHash ^= m_AgentVersion.GetHashCode(); // Fold in hash code for string MonitorVersion
            if (m_UserName != null) myHash ^= m_UserName.GetHashCode(); // Fold in hash code for string UserName
            if (m_UserDomainName != null) myHash ^= m_UserDomainName.GetHashCode(); // Fold in hash code for string UserDomainName
            if (m_HostName != null) myHash ^= m_HostName.GetHashCode(); // Fold in hash code for string HostName
            if (m_DnsDomainName != null) myHash ^= m_DnsDomainName.GetHashCode(); // Fold in hash code for string DNSDomainName
