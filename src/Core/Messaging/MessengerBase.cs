...
namespace Gibraltar.Messaging
{
    ...
    internal abstract class MessengerBase : IMessenger
    {
        ...
        private MessengerConfiguration m_Configuration;
        ...
        protected MessengerBase(bool supportsWriteThrough = true)
        {
        ...
        /// </summary>
        private void ActionOnConfigurationUpdate(MessengerConfiguration configuration)
        {
            try
            {
        ...
        /// </summary>
        private void ActionOnInitialize(MessengerConfiguration configuration)
        {
            try
            {
        ...
        protected void EnsureInitialized()
        {
            if (m_Initialized == false)
            {
                ...
                catch (Exception ex)
                {
                    ...
                    if ((ex is ThreadAbortException) == false)
                    {
                        //uh oh, we failed to initialize.  We'll need to stall out and see if we can recover.
                        if (Debugger.IsAttached)
                            Debugger.Break(); // Stop in debugger, ignore in production.
                    }
#endif
        ...
        /// This method is called with the Message Dispatch thread exclusively.</remarks>
        protected virtual void OnConfigurationUpdate(MessengerConfiguration configuration)
        {
            //we do nothing by default
        }
        ...
        /// This method is called with the Message Dispatch thread exclusively.</remarks>
        protected virtual void OnInitialize(MessengerConfiguration configuration)
        {
            //we do nothing by default
        }
        ...
        public void ConfigurationUpdated(MessengerConfiguration configuration)
        {
        ...
        /// <param name="configuration">The unique name for this messenger.</param>
        public void Initialize(Publisher publisher, MessengerConfiguration configuration)
        {
