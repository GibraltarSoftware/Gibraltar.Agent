...
namespace Gibraltar
{
    ...
    public static class StringReference
    {
        ...
        /// </summary>
        /// <remarks>When disabled each method returns immediately and the input string is returned.  This allows comparison of 
        ...
        public static void Pack()
        {
            ...
            {
#if DEBUG
                Trace.TraceError("While packing the string reference cache an exception was thrown: {0}", ex.Message, ex);
#endif
                GC.KeepAlive(ex); //just here to avoid a compiler warn in release mode
            }
        }
