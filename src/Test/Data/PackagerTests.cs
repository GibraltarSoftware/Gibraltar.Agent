...
namespace Gibraltar.Test.Data
{
    ...
    public class PackagerTests
    {
        ...
        private const int EmailOverrideServerPort = 587;
        private const bool EmailOverrideUseSsl = true;
        ...
        [Test]
        public void SendPackageViaEmail()
        {
            Assert.Throws<InvalidOperationException>(() =>
            {
                using (Packager newPackager = new Packager())
                {
                    newPackager.SendEmail(SessionCriteria.AllSessions, false, "SendPackageViaEmail", 
                        EmailFromAddress, EmailToAddress, string.Empty, 25, false, string.Empty, string.Empty, false);
                }
            });
        }

        [Test]
        public void SendPackageViaEmailOverrideServer()
        {
            Assert.Throws<SmtpException>(() =>
            {
                using (Packager newPackager = new Packager())
                {
                    newPackager.SendEmail(SessionCriteria.AllSessions, false, "SendPackageViaEmailOverrideServer", 
                        EmailFromAddress, EmailToAddress, EmailOverrideServer, EmailOverrideServerPort, EmailOverrideUseSsl, string.Empty, string.Empty, false);
                }
            });
        }

        [Ignore("Requires server configuration")]
        [Test]
        public void SendPackageViaEmailOverrideServerAndUser()
        {
            using (Packager newPackager = new Packager())
            {
                newPackager.SendEmail(SessionCriteria.NewSessions, false, "SendPackageViaEmailOverrideServerAndUser", 
                    EmailFromAddress, EmailToAddress, EmailOverrideServer, EmailOverrideServerPort, EmailOverrideUseSsl, EmailOverrideServerUser, EmailOverrideServerPassword, false);
            }
        }
        ...
        public void SendPackageViaWeb()
        {
            Assert.Throws<InvalidOperationException>(() =>
            {
                using (Packager newPackager = new Packager())
                {
                    ...
                    newPackager.SendToServer(SessionCriteria.AllSessions, false, false, false, null, false, null, null, 0, false, null, null, false);
                }
            });
        }
        ...
        public void SendPackageViaWebOverrideCustomer()
        {
            using (Packager newPackager = new Packager())
            {
                newPackager.SendToServer(SessionCriteria.AllSessions, false, false, true, null, true, ServerOverrideCustomerName, null, 0, false, null, null, false);
            }
        }
        ...
        public void SendPackageToLocalWebServer()
        {
            using (Packager newPackager = new Packager())
            {
                newPackager.SendToServer(SessionCriteria.AllSessions, false, false, true, null, false, null, "localhost", 58330, false, null, null, false);
            }
        }
        ...
        public void SendPackageViaWebFail()
        {
            Assert.Throws<GibraltarException>(() =>
            {
                using (Packager newPackager = new Packager())
                {
                    newPackager.SendToServer(SessionCriteria.AllSessions, false, false, true, null, true, "BogusNonexistentCustomer", null, 0, false, null, null, false);
                }
            });
        }
        ...
        public void SendPackageViaWebAsyncFail()
        {
            using (Packager newPackager = new Packager())
            {
                ...
                newPackager.SendToServer(SessionCriteria.AllSessions, false, false, true, null, true, "BogusNonexistentCustomer", null, 0, false, null, null, true);
