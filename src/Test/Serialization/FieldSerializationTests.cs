...
namespace Gibraltar.Serialization.UnitTests
{
    ...
    public class FieldSerializationTests
    {
        ...
        public void StringArray()
        {
            ...
            var stringList = new UniqueStringList();
            IFieldWriter writer = new FieldWriter(buffer, stringList, 2, 2);
            writer.Write(same);
            ...
            CompareArray(same, reader.ReadStringArray());
            CompareArray(different, reader.ReadStringArray());
            CompareArray(reverse, reader.ReadStringArray());
        }
